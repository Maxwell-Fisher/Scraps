::This was a script to get user input and move a character around the screen using that input, but it does'nt work in some confusing ways. Will probably fix it soon, though I have better movement scripts already so idk. Only works with QWERTY keyboard layouts
echo Loading...
@echo off
color 0F
title Broken controls - @Maxwellcrafter
setlocal
